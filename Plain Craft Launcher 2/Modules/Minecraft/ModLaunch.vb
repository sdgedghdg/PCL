...
#End Region
        ...
        '进程追踪标记
        If Settings.Get(Of Integer)("LaunchProcessTracking") >= 2 Then
            McLaunchInstanceId = Guid.NewGuid().ToString()
            Args.Add("-Dpcl2.instanceId=" & McLaunchInstanceId)
        End If
...
IgnoreCustomSkin:
    ...
    Private Sub McLaunchWait(Loader As LoaderTask(Of Process, Integer))
        ...
        '保存进程追踪信息
        ModWatcher.SaveTrackingAfterLaunch(Loader.Input, McInstanceSelected.Name)
